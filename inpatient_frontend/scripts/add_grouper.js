...
// define grouperDataGlobal
var grouperDataGlobal;
...
formCheck.addEventListener("submit", function (event) {
  ...
  fetch(`http://localhost:3006/frontend/getgrouper/${hospitalId}`, {
    method: "GET",
    headers: {
    ...
    .then((grouperData) => {
      ...
      // assign grouperData to grouperDataGlobal which will be accessed by edit from to fill
      grouperDataGlobal = grouperData;

     console.log("got data: ", grouperDataGlobal);

      document.getElementById("grouperDetails").style.display = "block";
    })
    .catch((error) => {
...
//   const grouperNameValue = document.getElementById("grouperName").value;
//   const grouperIdValue = document.getElementById("grouperId").value;

//   const grouperDetails = {
//     hospitalId: hospitalIdValue,
//     id: grouperIdValue,
//     row: grouperNameValue,
//   };

//   console.log(grouperDetails);

//   // Making the POST request
//   fetch("http://localhost:3006/frontend/addGrouper", {
//     method: "POST",
//     headers: {
//       "Content-Type": "application/json",
//     },
//     body: JSON.stringify(grouperDetails),
//   })
//     .then((response) => {
...
//           icon: "success",
//           title: "Success!",
//           text: "Grouper Added Successfully",
...
//           icon: "error",
//           title: "Error!",
//           text: "Grouper with this id already exists",
//           showConfirmButton: false, // Remove the confirm button
//           timer: 2000, // Automatically close after 1.5 seconds
//         });
//         console.error("Error in adding Grouper");
//       }
//     })
//     .catch((error) => {
//       console.error("Error in adding Grouper:", error);
//     });
// });
